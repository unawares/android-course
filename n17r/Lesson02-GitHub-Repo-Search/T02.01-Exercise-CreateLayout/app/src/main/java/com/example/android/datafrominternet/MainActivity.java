...
public class MainActivity extends AppCompatActivity {
    ...
    android.widget.EditText mSerachBoxEditText;
    // TODO (27) Create a TextView variable called mUrlDisplayTextView
    android.widget.TextView mUrlDisplayTextView;
    // TODO (28) Create a TextView variable called mSearchResultsTextView
    android.widget.TextView mSearchResultsTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSerachBoxEditText = (android.widget.EditText) findViewById(R.id.et_search_box);
